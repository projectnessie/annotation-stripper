...
dependencies {
  add("testCaseJakartaImplementation", "org.projectnessie.nessie:nessie-model:0.100.2")

  add("testCaseJakartaCompileOnly", "javax.ws.rs:javax.ws.rs-api:2.1.1")
  add("testCaseJakartaCompileOnly", "jakarta.ws.rs:jakarta.ws.rs-api:4.0.0")
  add("testCaseJakartaCompileOnly", "javax.validation:validation-api:2.0.1.Final")
  add("testCaseJakartaCompileOnly", "jakarta.validation:jakarta.validation-api:3.1.0")
}
